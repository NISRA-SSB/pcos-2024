...
There is no significant difference in the level of trust in NISRA between 2023 and 2022 (Chart 5).

When only respondents who expressed an opinion are considered, i.e. excluding 'don't knows', trust in NISRA in 2023 is slightly lower than in 2021, and similar to the levels of trust in 2019 and 2016. Trust in NISRA in 2023 is significantly higher than in 2014.
...
Across all institutions, trust is lowest for the media (`r trust_in_media`%) and elected bodies (`r trust_in_assembly`%), whilst `r trust_in_nics`% of respondents said they trust the Civil Service.
...
The level of trust in NISRA statistics (`r trust_in_nisra_stats`%) is higher than the level of trust in ONS statistics (`r trust_in_ons_stats`%).

While more respondents answered ‘don’t know’ with regard to NISRA statistics (`r dont_know_trust_nisra_stats`%) than for ONS statistics (`r dont_know_trust_ons_stats`%), the level of distrust in NISRA statistics (4%) is much lower than the level of distrust in ONS statistics (14%) (Chart 9).
...
While NISRA respondents are more likely to answer ‘don’t know’ (`r dont_know_importance`%) than ONS respondents (`r dont_know_importance_ons`%), the level of disagreement is notably lower for NISRA (`r disagree_importance`%) than it is for ONS (`r disagre_importance_ons`%) (Chart 11).
