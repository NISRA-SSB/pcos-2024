...
Awareness was highest for the Northern Ireland Census (`r heard_aware_census`%), followed by statistics on the number of people who live in Northern Ireland (`r heard_aware_people`%), and the unemployment rate (57%). Statistics on  the percentage of journeys made by walking, cycling or public transport (`r heard_of_aware_cycling`%) were the least recognised as being produced by NISRA.
...
Trust in NISRA is lower in 2024 than in 2023 (83%). Since 2020 (during the COVID-19 pandemic), trust in NISRA has decreased from 90% to 79%, and the percentage of respondents answering 'don't know' has increased from 7% to 16%. The level of distrust in NISRA has also increased from 2% to 6%. Current trust levels are comparable to those recorded in 2019 and earlier years (Chart 5).
