...
Detailed tables accompany the report and include the statistics underlying the charts and commentary as well as further breakdowns. Infographics are also available on ‘`r f_red_text("Public Awareness of NISRA")`’ and ‘`r f_red_text("Public Trust in Official Statistics")`’:
:::
